...
export class CollaborationService {
  ...
  // store collaborating clients' markers information and number
  clientsInfo: Object = {};
  clientNum: number = 0;
  ...
  init(editor: any, sessionId: string): void {
    ...
    /**
     * Listeners for events emitted from collaborator through server
     */
    ...
    this.collaborationSocket.on("cursorMove", (cursor) => {
      ...
      if (changeClientId in this.clientsInfo) {
        ...
        css.innerHTML = ".editor_cursor_" + changeClientId
          ...
          + " z-index:40; width:3px !important; }";
  ...
  /**
   * Event emitters to make changes and inform server and other collaborators
   */
  change(delta: string): void {
    this.collaborationSocket.emit("change", delta);
  }

  cursorMove(cursor): void {
